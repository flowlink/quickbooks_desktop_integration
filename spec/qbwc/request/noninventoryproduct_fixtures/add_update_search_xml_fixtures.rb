...
def add_xml_sorp_with_percent_noninventoryproduct
  <<~XML
    <ItemNonInventoryAddRq requestID="12345">
      <ItemNonInventoryAdd>
        <Name>test noninv product</Name>
...
def add_xml_sorp_without_percent_noninventoryproduct
  <<~XML
    <ItemNonInventoryAddRq requestID="12345">
      <ItemNonInventoryAdd>
        <Name>test noninv product</Name>
...
def update_xml_sandp_noninventoryproduct
  <<~XML
...
def update_xml_sorp_without_percent_noninventoryproduct
  <<~XML
    <ItemNonInventoryModRq requestID="12345">
      <ItemNonInventoryMod>
        <ListID>test noninv product</ListID>
...
def update_xml_sorp_with_percent_noninventoryproduct
  <<~XML
    <ItemNonInventoryModRq requestID="12345">
      <ItemNonInventoryMod>
        <ListID>test noninv product</ListID>
