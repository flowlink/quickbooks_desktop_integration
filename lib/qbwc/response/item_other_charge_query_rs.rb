  ...
  module Response
    class ItemOtherChargeQueryRs
      ...
      def process(config = {})
        ...
        puts({connection_id: config[:connection_id], method: "ItemOtherChargeQueryRs - process", receive_configs: receive_configs, records: records})
        ...
        if otherchargeproduct_params
          ...
          otherchargeproduct_params['otherchargeproducts']['quickbooks_since'] = last_time_modified
          otherchargeproduct_params['otherchargeproducts']['quickbooks_force_config'] = 'true'

          # Override configs to update timestamp so it doesn't keep geting the
          # same inventories
          params = otherchargeproduct_params['otherchargeproducts']
